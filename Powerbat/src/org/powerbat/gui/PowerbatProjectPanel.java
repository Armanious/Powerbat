 ...
 * {@link PowerbatProjectSelector}. In regards to other usage, there is none.
 * This will get information from project and use that to render an appropriate
 * UI.
 * 
 * @author Legend
 * @since 1.0
 * @see PowerbatProjectSelector
 */

public class PowerbatProjectPanel extends JPanel implements Comparable<PowerbatProjectPanel> {
	 ...
	 * 
	 * @param project
	 *            The project to get required information such as name and
	 *            difficulty.
	 * @author Legend
	 * @since 1.0
	 */

	public PowerbatProjectPanel(final Project project) {
		...
		open.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				PowerbatGUI.openProject(project);
			}
	...
	@Override
	public int compareTo(PowerbatProjectPanel o) {
