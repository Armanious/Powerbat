...
public class PowerbatResultsTable extends JTable implements TableCellRenderer {
	...
	private static final Color CORRECT = new Color(0, 120, 0, 255);
	private static final String[] HEADERS = new String[] { "Correct Answer", "Your Answer", "Parameters" };

	/**
	 * Constructs a new <tt>PowerbatResultsTable</tt> instance. This sets all
	 * static information in terms of display.
	 * 
	 * @param project
	 *            The project to which this table will display results of.
	 * @author Legend
	 * @since 1.0
	 */

	public PowerbatResultsTable(Project project) {
	 ...
	 * 
	 * @param results
	 *            The results returned from the execution of the runner.
	 * @author Legend
	 * @since 1.0
	 */
