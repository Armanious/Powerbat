...
public class PowerbatSplash extends JFrame implements WindowListener, MouseListener {
	 ...
	 * 
	 * @param should
	 *            Whether or not it should dispose and continue basic operation.
	 * @author Legend
	 * @since 1.0
	 */
	 ...
	 * 
	 * @param status
	 *            The message you would like to relay to the user.
	 * @author Legend
	 * @since 1.0
	 */

	public static void setStatus(String status) {
		PowerbatSplash.status = status;
	}
