...
public class CustomClassLoader extends ClassLoader {
	 ...
	 * 
	 * @param file
	 *            <tt>String instance for a file to load. File must exist.</tt>
	 ...
	 * 
	 * @param file
	 *            <tt>File</tt> instance to load the class from. This file must
	 *            exist.
	 * @return A class instance from a defined file.
	 */
	 ...
	 * 
	 * @param name
	 *            A <tt>String</tt> representing the name of the file for
	 *            definition.
	 * @param data
	 *            Bytes loaded from the class file.
	 * @return A class instance from a defined file.
	 */
	 ...
	 * 
	 * @param name
	 *            Name of the class for a definition.
	 * @param data
	 *            Data to read from.
	 * @return A class instance from a defined file.
	 */
